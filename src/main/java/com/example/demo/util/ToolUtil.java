...
public class ToolUtil {
     ...
     * 生成一个随机的密码
     *
     * @author liangyinan2001
     * @Date 2019/8/1 14:09
     */
    public static String getRandomPassword() {
        String base0 = "abcdefghijklmnopqrstuvwxyz";
        String base1 = "0123456789";
        String base2 = ".~!@$^&*";
        Random random = new Random();
        StringBuffer sb = new StringBuffer();
        for (int i = 0; i < 4; i++) {
            int number = random.nextInt(base0.length());
            sb.append(base0.charAt(number));
        }
        for (int i = 0; i < 3; i++) {
     ...
     * @return
     */
    public static boolean isBigDecimal(String valueStr) {
        try {
     ...
     * @return
     */
    public static String getStringValue(String str, String defaultValue) {
        if (isEmpty(str)) {
            return defaultValue;
        }
        return str;
